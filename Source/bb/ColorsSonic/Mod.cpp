...
extern "C" __declspec(dllexport) void Init()
{
	...
	// SonicType configuration
	switch (Configuration::sonicType)
	{
		case Colors:
		{
		...
		case ColorsUltimate:
		{
			ArchiveTreePatcher::m_archiveDependencies.push_back(ArchiveDependency("ColorsUltimateSonic", { sonicArchives }));
			break;
		}
	}
