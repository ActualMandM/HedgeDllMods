...
float Configuration::CustomCrossfade = 0.0f;
...
float Configuration::Custom2Crossfade = 0.0f;
...
bool Configuration::load(const std::string& filePath)
{
	...
	CustomCrossfade = reader.GetFloat("Config", "CustomCrossfade", 0.0f);
	...
	Custom2Crossfade = reader.GetFloat("Config", "Custom2Crossfade", 0.0f);
